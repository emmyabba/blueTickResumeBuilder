                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group position-relative">
                                                ...
                                                <input name="portfolio" id="portfolio" type="text" class="form-control pl-5" placeholder="e.g link to your website, linkedIn, portfolio, github etc.">
                                            </div>
                                        </div><!--end col-->
                                        <div class="col-lg-12">
                                            <div class="form-group position-relative">
                            ...
                            <div class="row">
                                <script>
                                    ...
                                    $(document).ready(function(){
                                        ...
                                        $("#portfolio").keyup(function(){
                                            // Getting the current value of textarea
                                            var currentText = $(this).val();
                                            // Setting the Div content
                                            $(".portfolio").text(currentText);
                                        });
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <p>
                                            <span class="text-info">Next steps for Windows and Mac users:</span>
                                            <br>
                                            <i>Click on Download my CV<br>
                                            When the Print screen pops up, go-to Destination and change selection to Save as PDF
                                            Click Save to download PDF</i>
                                        </p>
                                    </div>
